...
--
-- Host: localhost
-- Generation Time: Dec 20, 2019 at 07:52 AM
...
CREATE TABLE IF NOT EXISTS `mp_bank_opening` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_bank_transaction` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_barcode` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_brand` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_brand_sector` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_contactabout` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_customer_payments` (
  `id` int(11) NOT NULL,
  `transaction_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_drivers` (
  `id` int(11) NOT NULL,
  `name` varchar(255) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_expense` (
  `id` int(11) NOT NULL,
  `transaction_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_generalentry` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_head` (
  `id` int(11) NOT NULL,
  `name` varchar(255) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_langingpage` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_menulist` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_multipleroles` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_payee` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_printer` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_productslist` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_purchase` (
  `id` int(11) NOT NULL,
  `transaction_id` int(11) NOT NULL,
  `date` date NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_region` (
  `id` int(11) NOT NULL,
  `name` varchar(255) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_return` (
  `id` int(11) NOT NULL,
  `transaction_id` int(11) NOT NULL,
  `date` date NOT NULL,
  `cus_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_return_list` (
  `id` int(11) NOT NULL,
...
('02ca946fd9af36f4b6ed7cda7003ff53daf41540', '::1', 1576828284, 0x5f5f63695f6c6173745f726567656e65726174657c693a313537363832383238343b757365725f69647c613a323a7b733a323a226964223b733a313a2231223b733a343a226e616d65223b733a31323a225375707065722041646d696e223b7d),
('03a5cdb573d22d6eaeca8d1b3319ae1a1343e06e', '::1', 1576827948, 0x5f5f63695f6c6173745f726567656e65726174657c693a313537363832373934383b757365725f69647c613a323a7b733a323a226964223b733a313a2231223b733a343a226e616d65223b733a31323a225375707065722041646d696e223b7d),
('75969c9e50b491aaba3ccc4840a342a636a6d124', '::1', 1576828311, 0x5f5f63695f6c6173745f726567656e65726174657c693a313537363832383238343b757365725f69647c613a323a7b733a323a226964223b733a313a2231223b733a343a226e616d65223b733a31323a225375707065722041646d696e223b7d);
...
CREATE TABLE IF NOT EXISTS `mp_sub_entry` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_supplier_payments` (
  `id` int(11) NOT NULL,
  `transaction_id` int(11) NOT NULL,
  `supplier_id` int(11) NOT NULL,
  `amount` decimal(11,2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_supply` (
  `id` int(11) NOT NULL,
  `driver_id` int(11) NOT NULL,
  `vehicle_id` int(11) NOT NULL,
  `date` date NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_temp_barcoder_invoice` (
  `id` int(11) NOT NULL,
  `barcode` varchar(255) CHARACTER SET latin1 NOT NULL,
  `product_no` varchar(255) CHARACTER SET latin1 NOT NULL,
  `product_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_todolist` (
  `id` int(11) NOT NULL,
  `title` varchar(255) CHARACTER SET latin1 NOT NULL,
  `date` date NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mp_units` (
  `id` int(11) NOT NULL,
  `name` varchar(255) CHARACTER SET latin1 NOT NULL,
...
(1, 'Supper Admin', 'admin@gmail.com', '', '', '', '86ed815b3c9225ba422bcdad8cb8e3d8.png', 0, 'admin', '7c4a8d09ca3762af61e59520943dc26494f8941b', '2017-08-23', 'Jannat Group'),
...
CREATE TABLE IF NOT EXISTS `mp_vehicle` (
  `id` int(11) NOT NULL,
  `name` varchar(255) CHARACTER SET latin1 NOT NULL,
