    ...
    <div class="box" id="print-section">
        ...
        <div class="row">
            <div class="col-md-3"></div>
                <div class="col-md-6">
                  <h3 style="text-align:center; font-family: 'Poppins'">Statement of Income </h3>
                  <h3 style="text-align:center; font-family: 'Poppins'">
                   ...
                   <h4 style="text-align:center; font-family: 'Poppins'"> Reporting period: <b style="color: red"><?php echo $from.' to '.$to; ?></b> <b>
                   </h4>                   
                   <h4 style="text-align:center; font-family: 'Poppins'"> Created <?php echo Date('Y-m-d'); ?> <b>
                   </h4>
                </div>
                <div class="col-md-3"></div>  
        </div>
