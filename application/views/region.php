    ...
    <div class="row">
        <div class="col-md-12">
            <div class="pull pull-right">
                <button class="btn btn-info btn-outline-primary" onclick="show_modal_page('<?php echo base_url().'initilization/popup/add_region_model/'; ?>')" style="border-radius: 8px"><i class="fas fa-plus-square" aria-hidden="true"></i> 
                    Create Region
                </button>
                <button type="button" onclick="show_modal_page('<?php echo base_url();?>initilization/popup/add_csv_model/region')" class="btn btn-success btn-outline-primary " style="border-radius: 8px">
                    <i class="fas fa-upload" aria-hidden="true"></i>
                    Upload CSV
                </button>
                <a href="<?php echo base_url('initilization/export/region'); ?>" class="btn btn-primary btn-outline-primary " style="border-radius: 8px">
        ...
        <div class="col-xs-12">
            <div class="box" id="print-section">
                <div class="box-header">
                    <h3 class="box-title" style="font-family: 'Poppins'"><i class="fas fa-arrow-circle-right" aria-hidden="true"></i> <?php echo $table_name; ?>
                    </h3>
                </div>
                <div class="box-body">
