    ...
    <div class="box" id="print-section">
        <div class="box-body box-bg ">
            ...
            <div class="row no-print">
                ...
                <div class="form-group" style="margin-top: 21px;">
                        <?php
                            $data = array('style' => 'border-radius: 10px;','class'=>'btn btn-info btn-flat margin btn-lg pull-center','type' => 'submit','name'=>'btn_submit_customer','value'=>'true', 'content' => '<i class="fas fa-floppy-o" aria-hidden="true"></i> 
                                Create Statement');
        ...
        <div class="row">
            <div class="col-md-3"></div>
                <div class="col-md-6">
                   <h2 style="text-align:center; font-family: 'Poppins'">General Journal </h2>
                   ...
                   <h4 style="text-align:center; font-family: 'Poppins'">Created <?php echo Date('Y-m-d'); ?> 
                   </h4>
                </div>
            <div class="col-md-3"></div>  
        </div>
