<div class="modal-header">
	...
	<h4 class="modal-title" style="font-family: 'Poppins'"><i class="fas fa-plus-square" aria-hidden="true"></i> Add bank </h4>
</div>
		...
		<?php echo form_open('bank/add_bank',$attributes); ?>  
		  ...
		  <div class="form-group">  
  		  ...
  		  <div id="existing_account">	 	  
			  ...
			  <div class="form-group">  				
				<?php
					$data = array('style' => 'border-radius: 8px','class'=>'btn btn-info btn-outline-primary','type' => 'submit','name'=>'btn_submit_category','value'=>'true', 'content' => '<i class="fas fa-floppy-o" aria-hidden="true"></i> Save Bank');
