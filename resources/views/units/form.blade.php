            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="name_unit" class="col-lg-2 col-lg-offset-1 control-label">Unit</label>
                        <div class="col-lg-6">
                            <input type="text" name="name_unit" id="name_unit" class="form-control" required autofocus>
